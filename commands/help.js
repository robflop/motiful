...
exports.main = function(selfbot, msg, msgArray, chalk) {
    ...
    if(arg && cmdList.indexOf(arg) !== -1) return msg.channel.sendMessage(`**__Syntax for '${arg}' is:__** \`\`\`${config.commandPrefix + arg + " " + Commands.commands[arg].syntax}\`\`\``).then(msg => msg.delete(20000));
