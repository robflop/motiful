...
exports.main = function(client, msg, msgArray, chalk) {
    ...
    if(arg && cmdList.includes(arg)) return msg.channel.sendMessage(`**__Syntax for '${arg}' is:__** \`\`\`${config.commandPrefix + arg + " " + Commands.commands[arg].syntax}\`\`\``).then(msg => msg.delete(20000));
