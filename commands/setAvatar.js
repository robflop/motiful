...
exports.main = function(selfbot, msg, msgArray, chalk) {
	...
	if(!arg.startsWith("http")) return msg.edit("Invalid file or URL.").then(msg => msg.delete(2000));
	if(arg.substr(-4, 4) !== ".png" && arg.substr(-4, 4) !== ".jpg" && arg.substr(-4, 4) !== ".gif" && arg.substr(-5, 5) !== ".jpeg" && arg.substr(-5, 5) !== ".webp") return msg.edit("Invalid file format! Only png, jpg/jpeg, gif and webp are allowed.").then(msg => msg.delete(2000));
