...
exports.main = function(selfbot, msg, msgArray, chalk) { // Export command function
    ...
    return msg.edit(`Emote '${favmote}' not found on favorite emotes list!`).then(msg => msg.delete(2000));
    // ...notify user of error and set auto-delete to 2s and abort command execution
};
